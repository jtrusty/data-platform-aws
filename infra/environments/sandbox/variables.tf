...
variable "force_destroy_buckets" {
  description = "Allow Terraform to empty platform buckets during sandbox teardown."
  type        = bool
  default     = true
}
...
variable "secret_recovery_window_days" {
  description = "Secrets Manager deletion recovery window; zero is allowed in disposable sandbox."
  type        = number
  default     = 0
}
