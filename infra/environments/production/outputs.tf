...
output "foundation" {
  description = "Identifiers for the production data foundation."
  value = {
...
output "spend_controls" {
  description = "Budget, Athena limit, and alarm configuration for production."
  value = {
...
output "detection" {
  description = "Detective controls protecting production."
  value = {
