...
| <a name="input_enable_security_hub"></a> [enable\_security\_hub](#input\_enable\_security\_hub) | Enable Security Hub with the AWS Foundational Security Best Practices standard. | `bool` | `true` | no |
